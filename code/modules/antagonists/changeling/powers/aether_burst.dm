...
/datum/action/changeling/aether_burst
	name = "Aetheric Burst"
	desc = "We vent draconic plasma to shove ourselves through open space. Costs 3 chemicals."
...
/datum/action/changeling/aether_burst/sting_action(mob/living/user)
	...
	var/turf/target = get_ranged_target_turf(user, direction, 4)
