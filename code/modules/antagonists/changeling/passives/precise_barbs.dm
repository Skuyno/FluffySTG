...
/datum/changeling_genetic_matrix_recipe/precise_barbs
	...
	name = "Precise Barbs"
	description = "Refine our internal barbs into micro-anchors using vulpkanin pursuit sinew, nabber hunting hooks, and rabbit sprint cords to recycle stamina and chems."
	module = list(
		"id" = "matrix_precise_barbs",
		"name" = "Precise Barbs",
