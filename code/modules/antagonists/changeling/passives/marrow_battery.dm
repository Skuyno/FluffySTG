/// Passive: Marrow Battery — cultivates hemo-reactive marrow that refuels our chemical reserves on its own.
/datum/changeling_genetic_matrix_recipe/marrow_battery
        id = "matrix_marrow_battery"
        name = "Marrow Battery"
        description = "Spool hemophage marrow into a living capacitor that drips power back into our glands."
        module = list(
                "id" = "matrix_marrow_battery",
                "name" = "Marrow Battery",
