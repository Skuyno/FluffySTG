...
/datum/antagonist/changeling
	...
	/// Coordinates all genetic matrix state and effects.
	var/datum/changeling_matrix_manager/matrix_manager
	/// Handles changeling HUD setup and teardown.
	var/datum/changeling_ui_manager/ui_manager
...
/datum/antagonist/changeling/proc/apply_genetic_matrix_effects()
	return matrix_manager?.apply_genetic_matrix_effects()

/datum/antagonist/changeling/proc/is_genetic_matrix_module_active(module_identifier)
	return matrix_manager?.is_genetic_matrix_module_active(module_identifier)

/datum/antagonist/changeling/proc/update_matrix_predatory_howl(is_active)
	return matrix_manager?.update_matrix_predatory_howl(is_active)

/datum/antagonist/changeling/proc/update_matrix_symbiotic_overgrowth(is_active)
	return matrix_manager?.update_matrix_symbiotic_overgrowth(is_active)
...
/datum/antagonist/changeling/proc/ensure_matrix_aether_burst_action()
	return matrix_manager?.ensure_matrix_aether_burst_action()

/datum/antagonist/changeling/proc/remove_matrix_aether_burst_action()
	return matrix_manager?.remove_matrix_aether_burst_action()

/datum/antagonist/changeling/proc/apply_matrix_aether_drake_traits()
	return matrix_manager?.apply_matrix_aether_drake_traits()

/datum/antagonist/changeling/proc/remove_matrix_aether_drake_traits()
	return matrix_manager?.remove_matrix_aether_drake_traits()
...
/datum/antagonist/changeling/proc/update_matrix_echo_cascade_effect(is_active)
	return matrix_manager?.update_matrix_echo_cascade_effect(is_active)

/datum/antagonist/changeling/proc/clear_matrix_echo_cascade_timers()
	return matrix_manager?.clear_matrix_echo_cascade_timers()

/datum/antagonist/changeling/proc/update_matrix_abyssal_slip_effect(is_active)
	return matrix_manager?.update_matrix_abyssal_slip_effect(is_active)

/datum/antagonist/changeling/proc/apply_matrix_abyssal_slip_traits()
	return matrix_manager?.apply_matrix_abyssal_slip_traits()
...
/datum/antagonist/changeling/proc/update_matrix_neuro_sap_effect(is_active)
	return matrix_manager?.update_matrix_neuro_sap_effect(is_active)

/datum/antagonist/changeling/proc/update_matrix_chitin_courier_effect(is_active)
	return matrix_manager?.update_matrix_chitin_courier_effect(is_active)

/datum/antagonist/changeling/proc/ensure_matrix_chitin_courier_action()
	return matrix_manager?.ensure_matrix_chitin_courier_action()

/datum/antagonist/changeling/proc/remove_matrix_chitin_courier_action()
	return matrix_manager?.remove_matrix_chitin_courier_action()

/datum/antagonist/changeling/proc/apply_neuro_sap_bonus()
	return matrix_manager?.apply_neuro_sap_bonus()
...
/datum/antagonist/changeling/proc/ensure_matrix_spore_node_action()
	return matrix_manager?.ensure_matrix_spore_node_action()
...
/datum/antagonist/changeling/proc/on_life(datum/source, seconds_per_tick, times_fired)
	...
	if(matrix_manager?.matrix_symbiotic_overgrowth_active && living_owner?.stat != DEAD)
...
/datum/antagonist/changeling/proc/adjust_chemicals(amount, override_cap)
	...
	ui_manager?.update_chem_display()
